...
SELECT *
FROM Jobs j
JOIN Schedules s ON s.ScheduleID = j.JobScheduleID
WHERE j.IsEnabled = 'Yes'
AND	((s.Occurrence = 'Daily') OR
	 (s.Occurrence = 'Weekly'
		AND (s.Recurrence LIKE '%Saturday%' OR
			 s.Recurrence LIKE '%Sunday%')))